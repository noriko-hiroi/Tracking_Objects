...
dataset_path = "./"
l_csv_filename =["737059_20190101.csv"]
#l_csv_filename =["Est-aruba_5x5deg_2018001_2018180.csv"]
pkl_filename = "estchina_20190101_20190430_track.pkl"
pkl_filename_train = "estchina_20190101_20190228_train_track.pkl"
pkl_filename_valid = "estchina_20190301_20190331_valid_track.pkl"
pkl_filename_test  = "estchina_20190401_20190430_test_track.pkl"

cargo_tanker_filename = "estchina_20190101_20190228_tanker.npy"

t_train_min = time.mktime(time.strptime("01/01/2019 00:00:00", "%d/%m/%Y %H:%M:%S"))
t_train_max = time.mktime(time.strptime("28/02/2019 23:59:59", "%d/%m/%Y %H:%M:%S"))
t_valid_min = time.mktime(time.strptime("01/03/2019 00:00:00", "%d/%m/%Y %H:%M:%S"))
t_valid_max = time.mktime(time.strptime("31/03/2019 23:59:59", "%d/%m/%Y %H:%M:%S"))
t_test_min  = time.mktime(time.strptime("01/04/2019 00:00:00", "%d/%m/%Y %H:%M:%S"))
t_test_max  = time.mktime(time.strptime("30/04/2019 23:59:59", "%d/%m/%Y %H:%M:%S"))
t_min = time.mktime(time.strptime("01/01/2019 00:00:00", "%d/%m/%Y %H:%M:%S"))
t_max = time.mktime(time.strptime("30/04/2019 23:59:59", "%d/%m/%Y %H:%M:%S"))
...
#             timestamp = (utc_time - EPOCH).total_seconds()
            if count%1000000 == 0:
                print(count)
            count += 1
            datetime_obj = datetime.datetime.strptime(row[27], "%Y-%m-%d %H:%M:%S")
            unixtime = int(datetime_obj.timestamp())
            try:
                l_l_msg.append([float(row[17]),float(row[16]),
                               float(row[18]),float(row[19]),
                               int(row[21]),float(row[20]),
                               int(row[23]),unixtime,
                               int(float(row[1])),
                               int(row[6]),
                               float(row[14])])
